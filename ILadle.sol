...
interface ILadle {
    ...
    function pools(bytes6) external returns (IPool);
    ...
    function serve(bytes12 vaultId, address to, uint128 ink, uint128 base, uint128 max) external payable returns (uint128 art);
